...
@Component({
  selector: 'app-filter-project-sidebar',
  templateUrl: './filter-project-sidebar.component.html',
  styleUrls: ['./filter-project-sidebar.component.scss']
})
export class FilterProjectSidebarComponent implements OnInit {
  ...
  submit(form) {
    //if (form.valid) {
      this.toggleSidebar('filter-project-list');
    //}
    this.setFilters();
    this.fill.emit();
  }
