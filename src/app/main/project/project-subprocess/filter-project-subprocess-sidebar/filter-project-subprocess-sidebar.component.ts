...
@Component({
  selector: 'app-filter-project-subprocess-sidebar',
  templateUrl: './filter-project-subprocess-sidebar.component.html'
})
export class FilterProjectSubprocessSidebarComponent implements OnInit {
  public projectOwner;
  public brand;
  public subBrand;
  public itemName;
  ...
  submit(form) {
    //if (form.valid) {
      this.toggleSidebar('filter-project-subprocess');
    //}
    this.setFilters();
    this.fill.emit();
  }
